...
RUN \
  ...
  apt-get update && \
  apt-get install -y libapache2-mod-php7.1 php7.1-cli php7.1-common php7.1-curl php7.1-gd php7.1-mysql php7.1-sqlite php7.1-xml php7.1-zip php7.1-mbstring php7.1-mcrypt php7.1-intl php7.1-soap php7.1-imap imagemagick php-imagick graphicsmagick && \
